---
title: "Exploration and differential gene-expression analysis of TCGA - LUAD samples"
format: revealjs
editor: visual
---
...
- The aim of the project is to analyse differential gene expression between heavy, medium and light smokers to understand the impact of varying smoking intensities on lung adenocarcinoma samples.
...
- Hypothesis testing
- Identify Differentially Expressed Genes: Genes are classified as expressed based on user defined threshold for Log2FC and P-value
...
- PCA Biplot shows that other biological variables, like gender, should have been accounted for in modeling during the differential expression analysis.
