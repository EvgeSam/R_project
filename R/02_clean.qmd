...
Raw TCGA data -\> Add gene names -\> Undo log transform -\> Merge duplicate genes -\> Clean clinical metadata -\> Keep tumor samples -\> Reduce batch effects -\> Remove missing smoking data -\> Format for DESeq2 -\> Clean datasets
